...
DELETE FROM `player_factionchange_titles` WHERE `alliance_id`='147' and`horde_id`='154';
DELETE FROM `player_factionchange_titles` WHERE `alliance_id`='148' and`horde_id`='151';
DELETE FROM `player_factionchange_titles` WHERE `alliance_id`='149' and`horde_id`='150';